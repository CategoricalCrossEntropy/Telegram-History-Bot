...
USER_PROFILE_ACHIEVEMENTS = "Твои награды 🏅:\n\n{}"
ACHIEVEMENT_TEMPLATE = "{}: {} ({}⭐)\n"
USER_PROFILE_ACHIEVEMENTS_EMPTY = "Пока у тебя нет наград 😞\n\n"
...
ENTER_THE_CATEGORY = "Добавление вопроса:\n" \
                     ...
                     "✅ #\n\n" \
                     "{}"
ENTER_MACHINE_QUESTIONS = "Введите набор вопросов в машинном виде (или введите 0 для выхода в меню администратора):"
...
ENTER_THE_QUESTION = "Введите текст вопроса, который хотите добавить (или введите 0 для выхода в меню администратора):"
ENTER_THE_ANSWER = "Введите ответ на вопрос (или введите 0 для выхода в меню администратора):"
...
SET_CODEWORD = "Посмотреть/изменить кодовое слово 🔑"
SET_CODEWORD_DESCRIPTION = "Текущее кодовое слово: {}"
EMPTY_CODEWORD = "Отсутствует"
SET_NEW_CODEWORD = "Установить новое кодовое слово 🔑"
SET_NEW_CODEWORD_DESCRIPTION = "Здесь вы можете изменить кодовое слово для бота.\n" \
                               "При следующем входе пользователя, бот затребует у него указанное кодовое слово.\n\n" \
                               "Чтобы выйти из меню редактирования кодового слова, введите '0'\n" \
                               "✅ 0\n\n" \
                               "Введите новое кодовое слово для бота:"
...
SET_ACHIEVEMENTS = "Редактировать достижения 🏅"
ADMIN_EDIT_ACHIEVEMENTS_DESCRIPTION = "Эта команда устанавливает награды/достижения за XP.\n\n"\
                                      "Для установки новых достижений введите текст в следующем порядке:\n" \
                                      "Название достижения\n" \
                                      "Ссылка на награду(например, на диск с файлом)\n" \
                                      "Количество XP для получения награды\n" \
                                      "Предмет, к которому относится достижение\n\n" \
                                      "Текущие достижения:\n\n" \
                                      "{}\n" \
                                      "Если вы хотите удалить все достижения, введите '*'\n"\
                                      "✅ *\n\n"\
                                      "Чтобы выйти из меню редактирования достижений, введите '0'\n"\
                                      "✅ 0\n\n"\
                                      "Введите запрос:"
ALL_ACHIEVEMENTS_DELETED = "✅ Все достижения удалены"
SET_ACHIEVEMENTS_SUCCESS = "✅ Все достижения успешно заменены"
